...
function calc() {
	...
	function initLocalSettings(selector, activeClass) {
		...
		elements.forEach(elem => {
			...
			// important to put div in selector because 
...
function forms(formSelector, modalTimmerId) {
	
	const forms = document.querySelectorAll(formSelector);
	const message = {
		loading: 'img/form/spinner.svg',
		success: 'Sent! We will contact you',
	...
	function showThanksModal(message) {
		...
		(0,_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', modalTimmerId);
...
window.addEventListener('DOMContentLoaded', () => {
	...
	const modalTimmerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimmerId), 50000);

	(0,_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
	(0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]', '.modal', modalTimmerId);
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2023-12-09');
	(0,_modules_cards__WEBPACK_IMPORTED_MODULE_3__["default"])();
	(0,_modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"])();
	(0,_modules_forms__WEBPACK_IMPORTED_MODULE_5__["default"])('form', modalTimmerId);
